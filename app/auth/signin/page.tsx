  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-20 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden mesh-bg">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-accent/10 rounded-full blur-[120px] animate-glow-pulse" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-violet/10 rounded-full blur-[120px] animate-glow-pulse" style={{ animationDelay: "2s" }} />
      </div>
            ...
            <form action={loginAction} className="space-y-6">
              ...
              <div className="flex items-center justify-between text-xs sm:text-sm">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-muted hover:text-foreground transition-colors cursor-pointer">
                    Remember me
                  </label>
                </div>

                <Link href="#" className="font-semibold text-accent hover:text-accent/80 transition-colors">
                  Forgot password?
                </Link>
              </div>
